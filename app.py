...
#List vs Tuple vs Dictionary - فرق
# Feature 	                  List	                Tuple	              Dictionary
# Brackets	                   []	                     ()	                    {}
# Mutable?	              ✅ (Yes)	               ❌ (No)	               ✅ (Yes)
# Ordered?	              ✅ (Yes)	                ✅ (Yes)	              ❌ (No)
# Duplicate values allowed? ✅ (Yes) 	               ✅ (Yes)  	          ❌ (No - keys must be unique)
# Access method	        Index-based	                Index-based              Key-based
# Faster?              	Medium                      ✅ (Fast)	             Medium


# List کا استعمال تب کریں جب آپ کو بدلنے کے قابل آرڈر شدہ ڈیٹا چاہیے۔
# Tuple کا استعمال تب کریں جب آپ کو ناقابلِ تبدیل، محفوظ اور تیز ڈیٹا چاہیے۔
# Dictionary کا استعمال تب کریں جب آپ کو key-value format میں ڈیٹا رکھنا ہو۔

# Use List when you need ordered, mutable (modifiable) data.
# Use Tuple when you need immutable, secure, and faster data.
# Use Dictionary when you need to store data in a key-value format.
